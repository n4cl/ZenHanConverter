...
def test_ZenToHan():
    zen_to_han = ZenToHan(alphabet_table=True, number_table=True, ascii_symbol_table=True, space_table=True)
...
def test_HanToZen():
    han_to_zen = HanToZen(alphabet_table=True, number_table=True, ascii_symbol_table=True, space_table=True)
